...
// CREATE RECIPE PAGE FUNCTIONS

/*
// Get image preview element
let preview = document.getElementById('display-image')
...
document.getElementById('input-img').addEventListener('change', e => {
  ...
  reader.onloadend = () => {
    ...
    // Set img preview source to file image
    preview.setAttribute('src', `data:image/png;base64,${base64String}`)
  }
...
/*
 * Function to get image and display it on preview
 */
/*
